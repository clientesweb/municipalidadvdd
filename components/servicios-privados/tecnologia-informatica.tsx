...
export default function TecnologiaInformatica() {
  return (
      ...
      <div className="pl-6">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Servicio: Reparación de PC, instalación de cámaras de seguridad, filmación con drones, instalación de
            Internet Starlink, automatización de hogares con asistencia virtual (Alexa)
          </p>
          <div className="space-y-1 text-sm">
            <div className="flex items-center space-x-2">
              <span className="font-medium">• De Leandro Miguel Reyes</span>
            </div>
            <div className="flex items-center space-x-2">

...
export default function NauticaEmbarcaciones() {
  return (
      ...
      <div className="pl-6">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Servicio: Fabricación de hidropedales y reparaciones en fibra de vidrio, gestoría náutica, traslado de
            embarcaciones
          </p>
          <div className="space-y-1 text-sm">
            <div className="flex items-center space-x-2">
              <span className="font-medium">• Toccoli Franco Germán</span>
            </div>
            <div className="flex items-center space-x-2">

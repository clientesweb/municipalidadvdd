      ...
      <footer className="w-full bg-[#16b5d0] text-white py-8 sm:py-10 md:py-12 px-4">
        <div className="container mx-auto">
          ...
          <div className="border-t border-white/20 mt-6 sm:mt-8 pt-4 sm:pt-6 text-center space-y-2">
            <p className="text-sm sm:text-base opacity-80 font-montserrat">© 2024 Municipalidad de Villa del Dique</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
              ...
              <p className="text-sm font-montserrat">
                ...
                <button
                  ...
                  className="font-semibold text-white hover:underline hover:opacity-90 transition-all duration-200 cursor-pointer"
                >
                  Common Creator
                </button>
              </p>

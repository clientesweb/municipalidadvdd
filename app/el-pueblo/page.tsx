...
import { Menu, X, ArrowLeft, Calendar, Users, Mountain, Waves, Camera, Music, Car, Bed, TreePine } from "lucide-react"
      ...
      <main className="flex-grow container mx-auto py-8 px-4 sm:py-12 md:py-16 lg:py-20">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-2xl sm:text-3xl font-nunito text-[#16b5d0] font-bold mb-4">La Perla de Calamuchita</p>
            <p className="text-xl font-montserrat text-gray-600 max-w-4xl mx-auto leading-relaxed">
        ...
        <section className="mb-16">
          <div className="bg-white shadow-xl rounded-lg p-8 lg:p-12">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-nunito font-bold text-gray-900 mb-6">Nuestro Pueblo</h2>
                <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
                ...
                <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-6">
                ...
                <div className="flex items-center space-x-4 text-[#16b5d0] font-montserrat">
          ...
          <div className="bg-gradient-to-r from-[#16b5d0] to-[#0ea5e9] text-white py-4 px-6 rounded-t-lg">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl sm:text-3xl font-nunito font-bold">
                HISTORIA: UNA TIERRA NACIDA DEL AGUA Y LAS SIERRAS
              </h2>
            </div>
          </div>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-[#16b5d0] to-[#0ea5e9] text-white py-4 px-6 rounded-t-lg">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl sm:text-3xl font-nunito font-bold">COSTUMBRES Y TRADICIONES</h2>
            </div>
          </div>
          ...
          <div className="bg-white shadow-xl rounded-b-lg p-8 lg:p-12">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 font-montserrat text-gray-700 mb-6">
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-[#16b5d0] to-[#0ea5e9] text-white py-4 px-6 rounded-t-lg">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl sm:text-3xl font-nunito font-bold">CULTURA Y ENTRETENIMIENTOS</h2>
            </div>
          </div>
          ...
          <div className="bg-white shadow-xl rounded-b-lg p-8 lg:p-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-[#16b5d0]/10 rounded-lg">
                ...
                <h4 className="font-nunito font-semibold text-gray-900 mb-2">Paseo de Artesanos</h4>
                <p className="text-sm font-montserrat text-gray-600">Exposición y venta de artesanías locales</p>
              </div>
              <div className="text-center p-4 bg-[#16b5d0]/10 rounded-lg">
                <Music className="h-8 w-8 text-[#16b5d0] mx-auto mb-3" />
                <h4 className="font-nunito font-semibold text-gray-900 mb-2">Viernes Peatonales</h4>
                <p className="text-sm font-montserrat text-gray-600">Música en vivo sobre la avenida principal</p>
              </div>
              <div className="text-center p-4 bg-[#16b5d0]/10 rounded-lg">
                <Users className="h-8 w-8 text-[#16b5d0] mx-auto mb-3" />
                <h4 className="font-nunito font-semibold text-gray-900 mb-2">Obras de Teatro</h4>
                <p className="text-sm font-montserrat text-gray-600">Presentaciones teatrales locales</p>
              </div>
              <div className="text-center p-4 bg-[#16b5d0]/10 rounded-lg">
                <Users className="h-8 w-8 text-[#16b5d0] mx-auto mb-3" />
                <h4 className="font-nunito font-semibold text-gray-900 mb-2">Literatura</h4>
                <p className="text-sm font-montserrat text-gray-600">Presentaciones literarias y culturales</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-[#16b5d0] to-[#0ea5e9] text-white py-4 px-6 rounded-t-lg">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl sm:text-3xl font-nunito font-bold">
                ATRACTIVOS TURÍSTICOS: EN EL AGUA Y LAS MONTAÑAS
              </h2>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-2xl font-nunito font-bold text-gray-900">El Lago</h3>
                  </div>
                  <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
                    Ideal para practicar deportes acuáticos como:
                  </p>
                  <div className="grid grid-cols-2 gap-2 font-montserrat text-gray-700">
                    <div className="flex items-center space-x-2">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-2xl font-nunito font-bold text-gray-900">Senderos y Miradores Serranos</h3>
                </div>
                <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4 font-montserrat">
              ...
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  <TreePine className="h-6 w-6 text-[#16b5d0]" />
                  <h3 className="text-2xl font-nunito font-bold text-gray-900">Camping y Balneario Municipal</h3>
                </div>
                <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 font-montserrat text-gray-700">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-[#16b5d0] rounded-full"></div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex items-center space-x-3 mb-4">
                  <TreePine className="h-6 w-6 text-[#16b5d0]" />
                  <h3 className="text-2xl font-nunito font-bold text-gray-900">Espacios Verdes</h3>
                </div>
                <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
                  La Perla de Calamuchita cuenta con numerosos espacios verdes y plazas con juegos para las infancias:
                </p>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 font-montserrat text-gray-700">
                  <div className="flex items-center space-x-2">
          ...
          <section className="bg-white shadow-xl rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-[#16b5d0] to-[#0ea5e9] text-white py-4 px-6">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-2xl font-nunito font-bold">CÓMO LLEGAR</h2>
              </div>
            </div>
            <div className="p-6">
              <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
          ...
          <section className="bg-white shadow-xl rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-[#16b5d0] to-[#0ea5e9] text-white py-4 px-6">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-2xl font-nunito font-bold">DÓNDE ALOJARSE</h2>
              </div>
            </div>
            <div className="p-6">
              <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-lg font-montserrat text-gray-700 leading-relaxed mb-3">
        ...
        <section className="bg-gradient-to-r from-[#16b5d0]/10 to-[#0ea5e9]/10 p-8 lg:p-12 rounded-lg text-center">
          <h2 className="text-3xl font-nunito font-bold text-gray-900 mb-6">El Lugar Ideal</h2>
          <p className="text-xl font-montserrat text-gray-700 leading-relaxed max-w-4xl mx-auto">

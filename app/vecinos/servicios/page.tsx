...
import ClimatizacionGasPlomeria from "@/components/servicios-privados/climatizacion-gas-plomeria"
import InmobiliariasYBienesRaices from "@/components/servicios-privados/inmobiliarias-bienes-raices"
import SalonesYEventos from "@/components/servicios-privados/salones-eventos"
import Parquizaciones from "@/components/servicios-privados/parquizaciones"
import AlbanileriaYConstruccion from "@/components/servicios-privados/albanileria-construccion"
import Soldadores from "@/components/servicios-privados/soldadores"
import Electricistas from "@/components/servicios-privados/electricistas"
import ServicioDeLimpieza from "@/components/servicios-privados/servicio-limpieza"
import ServiciosDeSalud from "@/components/servicios-privados/servicios-salud"
import Educacion from "@/components/servicios-privados/educacion"
import Matafuegos from "@/components/servicios-privados/matafuegos"
import Seguros from "@/components/servicios-privados/seguros"
import MecanicaLubricentro from "@/components/servicios-privados/mecanica-lubricentro"
import LavaderosAutos from "@/components/servicios-privados/lavaderos-autos"
import TecnologiaInformatica from "@/components/servicios-privados/tecnologia-informatica"
import NauticaEmbarcaciones from "@/components/servicios-privados/nautica-embarcaciones"
import MotosVentaConsignacion from "@/components/servicios-privados/motos-venta-consignacion"
import HerreriaMetalurgica from "@/components/servicios-privados/herreria-metalurgica"
import Seguridad from "@/components/servicios-privados/seguridad"
import AlquilerBanosSanitarios from "@/components/servicios-privados/alquiler-banos-sanitarios"
import EstudiosAgrimensuraArquitectura from "@/components/servicios-privados/estudios-agrimensura-arquitectura"
      ...
      <main className="flex-grow container mx-auto py-8 px-4 sm:py-12 md:py-16 lg:py-20">
        ...
        <div className="space-y-6">
          <Accordion type="multiple" className="w-full">
            ...
            {/* SERVICIOS PRIVADOS - Refactorizado con componentes separados */}
            <AccordionItem value="item-6" className="bg-white shadow-xl rounded-lg overflow-hidden mb-6">
              ...
              <AccordionContent className="p-6 sm:p-8 font-montserrat space-y-8">
                ...
                <ClimatizacionGasPlomeria />
                <InmobiliariasYBienesRaices />
                <SalonesYEventos />
                <Parquizaciones />
                <AlbanileriaYConstruccion />
                <Soldadores />
                <Electricistas />
                <ServicioDeLimpieza />
                <ServiciosDeSalud />
                ...
                <NauticaEmbarcaciones />
                <MotosVentaConsignacion />
                <HerreriaMetalurgica />
                <Seguridad />
                <AlquilerBanosSanitarios />
                <EstudiosAgrimensuraArquitectura />
              </AccordionContent>
            </AccordionItem>

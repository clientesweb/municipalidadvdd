...
export default function MejorasInfraestructuraPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "La Municipalidad de Villa del Dique continúa avanzando en el fortalecimiento de la infraestructura pública con la instalación de un cerco perimetral de 74 metros y reorganización del estacionamiento.",
  ...
  const shareOnSocial = (platform: "facebook" | "twitter" | "whatsapp") => {
    ...
    const title = encodeURIComponent("Mejoras en infraestructura para una comunidad más segura y ordenada")
    const text = encodeURIComponent(
      "La Municipalidad de Villa del Dique continúa avanzando en el fortalecimiento de la infraestructura pública.",
    )
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              Mejoras en infraestructura para una comunidad más segura y ordenada
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">22 de octubre de 2024</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-[#16b5d0]/10 border-l-4 border-[#16b5d0] p-4 mb-8">
              <p className="text-lg font-semibold text-[#16b5d0]">
                🏗️ MEJORAS EN INFRAESTRUCTURA: Villa del Dique avanza en el fortalecimiento de espacios públicos para una
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8">
              En el marco de nuestro compromiso con la seguridad y el bienestar de la comunidad, la{" "}
              <strong>Municipalidad de Villa del Dique</strong> continúa avanzando en el{" "}
              <strong>fortalecimiento de la infraestructura pública</strong>.
            </p>

            {/* Hero Image */}
            <div className="mb-12">
              <Image
                src="/la-villa-que-queremos.jpg"
                alt="La Villa que Queremos - Estacionamiento y cerco perimetral en la Escuela Primaria"
                width={800}
                height={600}
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              En esta oportunidad, se ha concretado la <strong>instalación de un cerco perimetral de 74 metros</strong>{" "}
              y la <strong>reorganización integral del espacio destinado al estacionamiento</strong>. Estas acciones
              permiten optimizar la seguridad del entorno y mejorar la circulación y el acceso a las instituciones
              ubicadas en el sector.
            </p>

            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              Gracias a esta intervención, ahora se cuenta con una{" "}
              <strong>capacidad ordenada para 25 vehículos y 20 motocicletas</strong>, lo que contribuye
              significativamente a un entorno más funcional, seguro y accesible para vecinos, trabajadores y visitantes.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#16b5d0]/10 to-[#0ea5e9]/10 border-l-4 border-[#16b5d0] p-6 mb-8 rounded-r-lg">
              <blockquote className="text-xl text-gray-800 font-medium italic leading-relaxed">
                "Con el acompañamiento de la comunidad, seguimos construyendo un futuro más seguro y ordenado para
                todos"
              </blockquote>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Video: La Villa que Queremos</span>
              </h3>
                ...
                <div className="relative w-full max-w-md mx-auto bg-black rounded-lg overflow-hidden shadow-lg">
                  <div style={{ aspectRatio: "9/16" }}>
                    <video
                      ...
                      poster="/la-villa-que-queremos.jpg"
                      preload="metadata"
                    >
                      <source src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/la-villa-que-queremos-5T7FBinbXpKahL0EucngJxvSZlQ5FM.mp4" type="video/mp4" />
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-sm text-gray-600 text-center">
                      <strong>Video oficial:</strong> Vista aérea de las mejoras en infraestructura realizadas en el
                      estacionamiento y cerco perimetral de la Escuela Primaria.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#16b5d0]">
                  <h4 className="text-xl font-bold text-gray-900 mb-4">Infraestructura Instalada</h4>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start space-x-2">
                      <span className="text-[#16b5d0] font-bold">•</span>
                      <span>Cerco perimetral de 74 metros</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#16b5d0] font-bold">•</span>
                      <span>Reorganización integral del estacionamiento</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#16b5d0] font-bold">•</span>
                      <span>Mejora en la circulación vehicular</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#16b5d0] font-bold">•</span>
                      <span>Optimización de la seguridad del entorno</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#0ea5e9]">
                  <h4 className="text-xl font-bold text-gray-900 mb-4">Capacidad y Beneficios</h4>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start space-x-2">
                      <span className="text-[#0ea5e9] font-bold">•</span>
                      <span>25 espacios para vehículos</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#0ea5e9] font-bold">•</span>
                      <span>20 espacios para motocicletas</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#0ea5e9] font-bold">•</span>
                      <span>Entorno más funcional y accesible</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#0ea5e9] font-bold">•</span>
                      <span>Mayor seguridad para la comunidad</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section className="mb-12">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Esta intervención representa un paso importante hacia la construcción de una{" "}
                <strong>Villa del Dique más ordenada y segura</strong>, beneficiando a:
              </p>
              ...
              <div className="bg-gray-50 p-8 rounded-lg mb-12">
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Vecinos</p>
                      <p className="text-gray-600">Mayor seguridad y orden en el acceso a instituciones públicas</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Trabajadores</p>
                      <p className="text-gray-600">
                        Espacios organizados y funcionales para el desarrollo de actividades
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Mejor accesibilidad y experiencia en el uso de servicios públicos</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Agradecimiento Especial</span>
              </h3>

              <div className="bg-gradient-to-r from-[#16b5d0]/5 to-[#0ea5e9]/5 p-8 rounded-lg border border-[#16b5d0]/20">
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Queremos expresar un <strong>especial agradecimiento a la familia Tapia</strong>, cuya colaboración ha
                  sido fundamental para llevar adelante esta mejora.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Su compromiso con el desarrollo de nuestra comunidad demuestra que{" "}
                  <strong>trabajando juntos podemos lograr grandes transformaciones</strong> para el bienestar de todos.
                </p>
              </div>
            </section>
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-12">
              <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                Con el <strong>acompañamiento de la comunidad</strong>, seguimos construyendo un{" "}
                <strong>futuro más seguro y ordenado para todos</strong>, demostrando que Villa del Dique avanza hacia
                la <strong>Villa que Queremos</strong>.
              </p>
            </div>
          </div>

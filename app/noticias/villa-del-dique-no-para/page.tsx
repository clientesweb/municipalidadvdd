...
export default function VilladelDiqueNoParaPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "El Municipio de Villa del Dique continúa ejecutando importantes obras durante el receso invernal. Conoce todos los avances.",
  ...
  const shareOnSocial = (platform: "facebook" | "twitter" | "whatsapp") => {
    ...
    const title = encodeURIComponent("Villa del Dique No Para: Avances de Obras Públicas Durante el Receso Invernal")
    const text = encodeURIComponent(
      "El Municipio de Villa del Dique continúa ejecutando importantes obras durante el receso invernal.",
    )
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">8 de julio de 2025</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-[#16b5d0]/10 border-l-4 border-[#16b5d0] p-4 mb-8">
              <p className="text-lg font-semibold text-[#16b5d0]">
                ⚡ IMPORTANTE: Villa del Dique continúa con importantes obras de infraestructura durante el receso
                invernal
              </p>
            </div>
          </div>

          {/* Article Content - Rest of the content remains the same */}
          <div className="prose prose-lg max-w-none">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8">
              Mientras los niños y niñas disfrutan del receso invernal, el <strong>Municipio de Villa del Dique</strong>{" "}
              continúa ejecutando importantes obras en distintos puntos de la localidad. Estas acciones no solo mejoran
              la infraestructura urbana, sino que también{" "}
              <strong>impulsan el desarrollo social y económico del pueblo</strong>. A continuación, se detallan los
              principales avances:
            </p>
            ...
            <div className="mb-12">
              <Image
                ...
                alt="Villa del Dique No Para - Obras en progreso"
                width={800}
                height={600}
            ...
            {/* Finalización de la Sala Cuna */}
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Finalización de la Sala Cuna</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">
                    Está en su <strong>etapa final la construcción del edificio de la sala cuna</strong>. Ya se
                    completaron el revoque, el contrapiso y la instalación de las aberturas externas. En los próximos
                    días se colocarán las aberturas internas y los artefactos sanitarios.
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Esta obra permitirá{" "}
                    <strong>ampliar la oferta de servicios de cuidado y atención para la primera infancia</strong>,
                    beneficiando directamente a <strong>más de 40 familias de la zona</strong>.
                  </p>
                </div>
                <div>
                  <Image
                    src="/images/nuevo-edificio-sala-cuna.webp"
                    alt="Construcción del nuevo edificio de la Sala Cuna"
                    width={600}
                    height={400}
            ...
            {/* Adoquinado en el Barrio IPV */}
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Adoquinado en el Barrio IPV</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <Image
                    src="/images/obras-barrio-ipv.webp"
                    alt="Trabajos de adoquinado en el barrio IPV"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
                ...
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Se avanza con el <strong>adoquinado de calles en el barrio IPV</strong>, lo que mejorará
                    considerablemente la transitabilidad, especialmente en épocas de lluvia. Este tipo de intervención
                    busca <strong>reducir la erosión y mejorar el acceso vehicular y peatonal</strong>.
                  </p>
                </div>
              </div>
            </section>

            {/* Mejoras en la Escuela Almirante Brown */}
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Mejoras en la Escuela Almirante Brown</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Se trabaja en la <strong>construcción del cerco perimetral del playón deportivo</strong> de la
                    Escuela Almirante Brown, brindando{" "}
                    <strong>mayor seguridad y mejores condiciones para la práctica de actividades deportivas</strong>{" "}
                    por parte de los estudiantes y la comunidad.
                  </p>
                </div>
                <div>
                  <Image
                    src="/images/cerco-escuela-almirante-brown.webp"
                    alt="Construcción del cerco perimetral en la Escuela Almirante Brown"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
            ...
            {/* Nueva Oficina de Reclamos Municipal */}
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Nueva Oficina de Reclamos Municipal</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <Image
                    src="/images/oficina-reclamos-salon-municipal.webp"
                    alt="Trabajos en la nueva Oficina de Reclamos en el salón municipal"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
                ...
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    En breve comenzará a funcionar una <strong>nueva Oficina de Reclamos en el salón municipal</strong>,
                    que facilitará la <strong>atención directa a los vecinos</strong>. Solo resta concluir los trabajos
                    de acceso, que se encuentran próximos a finalizar.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Embellecimiento Urbano</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Continúan las <strong>tareas de limpieza y pintura de cordones cuneta</strong> en distintos sectores
                    del casco urbano, una acción orientada a{" "}
                    <strong>mejorar la imagen del pueblo y fomentar el sentido de pertenencia</strong> de los
                    ciudadanos.
                  </p>
                </div>
                <div>
                  <Image
                    src="/images/mantenimiento-cordones-cuneta.webp"
                    alt="Mantenimiento y pintura de cordones cuneta"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
            ...
            {/* Anfiteatro del Polo Cultural */}
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Anfiteatro del Polo Cultural</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <Image
                    src="/images/anfiteatro-polo-cultural.webp"
                    alt="Construcción del anfiteatro en el Polo Cultural"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
                ...
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    La obra del <strong>anfiteatro en el Polo Cultural alcanza ya el 50% de avance</strong>. Este
                    espacio será clave para el{" "}
                    <strong>desarrollo de eventos culturales, conciertos y espectáculos al aire libre</strong>,
                    fortaleciendo la vida cultural y turística de Villa del Dique.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-12">
              <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                Con cada obra que avanza,{" "}
                <strong>
                  Villa del Dique se transforma en un lugar más moderno, inclusivo y preparado para el futuro
                </strong>
                . Desde la gestión municipal, se reafirma el compromiso de seguir trabajando para{" "}
                <strong>mejorar la calidad de vida de todos los vecinos</strong>.
              </p>
            </div>
          </div>

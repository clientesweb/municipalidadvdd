...
export default function InauguracionPoloCulturalPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "Desde el viernes 12 de septiembre, Villa del Dique contará con un nuevo Polo Cultural. Conoce todos los detalles.",
  ...
  const shareOnSocial = (platform: "facebook" | "twitter" | "whatsapp") => {
    ...
    const title = encodeURIComponent("Villa del Dique inaugura su nuevo Polo Cultural")
    const text = encodeURIComponent(
      "Desde el viernes 12 de septiembre, Villa del Dique contará con un nuevo Polo Cultural.",
    )
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              🎭 Villa del Dique inaugura su nuevo Polo Cultural
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">6 de septiembre de 2025</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-[#16b5d0]/10 border-l-4 border-[#16b5d0] p-4 mb-8">
              <p className="text-lg font-semibold text-[#16b5d0]">
                🎭 IMPORTANTE: Villa del Dique inaugura su nuevo Polo Cultural el viernes 12 de septiembre
              </p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8">
              Desde el <strong>viernes 12 de septiembre</strong>, Villa del Dique contará con un{" "}
              <strong>nuevo Polo Cultural</strong>, un espacio pensado para el encuentro, la creatividad y el desarrollo
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Este importante proyecto integra:</span>
              </h2>

              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">🏛 La renovada Casa de la Cultura</h3>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Espacio histórico completamente restaurado que conserva su valor patrimonial mientras se adapta a
                    las necesidades culturales actuales.
                  </p>
                </div>

                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">🎭 El Centro Cultural Pato Carret</h3>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Centro emblemático que continuará siendo un punto de referencia para las actividades artísticas y
                    culturales de la comunidad.
                  </p>
                </div>

                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">🎶 El nuevo anfiteatro al aire libre</h3>
                  <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mt-6">
                Todo ubicado en el <strong>mismo sector de la Oficina de Turismo</strong>, formando un{" "}
                <strong>verdadero corazón cultural para el pueblo</strong>.
              </p>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Visión de Desarrollo Cultural</span>
              </h2>

              <div className="bg-[#16b5d0]/5 border-l-4 border-[#16b5d0] p-6 rounded-r-lg">
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  El <strong>intendente Emiliano Torres</strong> destacó que el objetivo es{" "}
                  <strong>generar un punto de encuentro para artistas, instituciones y vecinos</strong>, promoviendo el
                  crecimiento cultural y social de Villa del Dique.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Este proyecto representa una{" "}
                  <strong>inversión estratégica en el desarrollo cultural y turístico</strong> de la localidad, creando
                  nuevas oportunidades para el crecimiento económico y social.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">📢 Invitación especial</span>
              </h2>

              <div className="bg-gradient-to-r from-[#16b5d0]/10 to-[#16b5d0]/5 p-8 rounded-lg border border-[#16b5d0]/20">
                <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                  <strong>¡Todos los vecinos están invitados a participar del acto inaugural!</strong>
                </p>
                <p className="text-lg text-gray-700 leading-relaxed text-center mt-4">
                  Celebremos juntos este nuevo espacio para la cultura local que fortalecerá nuestra identidad y
                  promoverá el desarrollo artístico de Villa del Dique.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Detalles del Acto Inaugural</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                  <h3 className="text-lg font-bold text-gray-900 mb-3">📅 Fecha y Hora</h3>
                  <p className="text-gray-700">
                    <strong>Viernes 12 de septiembre</strong>
                    <br />
                    11:00 hs
                  </p>
                </div>
                ...
                <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Nuevo Polo Cultural
                    <br />
                    Sector Oficina de Turismo
                  </p>
                </div>
              </div>

              <div className="mt-6 bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-bold text-gray-900 mb-3">🎭 Programa</h3>
                <ul className="text-gray-700 space-y-2">
                  <li>• Intervenciones culturales</li>
                  <li>• Muestra de las renovadas instalaciones de la histórica Casa de la Cultura</li>
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-12">
              <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                Con la inauguración de este <strong>Polo Cultural</strong>,{" "}
                <strong>Villa del Dique da un paso importante hacia el fortalecimiento de su identidad cultural</strong>{" "}
                y se posiciona como un destino atractivo para el turismo cultural de la región.
              </p>
            </div>
          </div>

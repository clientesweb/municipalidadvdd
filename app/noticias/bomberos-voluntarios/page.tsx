...
export default function BomberosVoluntariosPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Reconocimiento y apoyo a nuestros bomberos voluntarios: acompañamiento a una inversión histórica",
      text: "El intendente de Villa del Dique acompañó a los bomberos voluntarios en la recepción de un aporte de 15 millones de pesos.",
  ...
  const shareOnSocial = (platform: "facebook" | "twitter" | "whatsapp") => {
    ...
    const title = encodeURIComponent(
      "Reconocimiento y apoyo a nuestros bomberos voluntarios: acompañamiento a una inversión histórica",
    )
    const text = encodeURIComponent(
      "El intendente de Villa del Dique acompañó a los bomberos voluntarios en la recepción de un aporte de 15 millones de pesos.",
    )
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">22 de julio de 2025</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-[#16b5d0]/10 border-l-4 border-[#16b5d0] p-4 mb-8">
              <p className="text-lg font-semibold text-[#16b5d0]">
                🚒 IMPORTANTE: Inversión histórica de 15 millones de pesos para bomberos voluntarios de Villa del Dique
              </p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8">
              El intendente de Villa del Dique, <strong>Emiliano Torres</strong>, acompañó a los bomberos voluntarios de
              nuestra localidad en la recepción de un aporte de <strong>15 millones de pesos</strong> otorgado por el
              Gobierno de la Provincia de Córdoba. Este desembolso forma parte de un plan provincial que contempla una
              segunda entrega del mismo monto, destinado a los <strong>191 cuarteles de bomberos voluntarios</strong> de
              toda la provincia.
            </p>
            ...
            <div className="mb-12">
              <Image
                src="/images/bomberos-recaudacion.jpg"
            ...
            <blockquote className="text-xl text-gray-800 italic border-l-4 border-[#16b5d0] pl-6 my-8">
              "Quien es bombero voluntario es un ejemplo de vocación y entrega para toda la comunidad. Los bomberos
              cordobeses son reconocidos en el mundo por el gran profesionalismo con el que trabajan. Todos tenemos que
              estar orgullosos de ellos y apoyarlos"
              <footer className="text-base text-gray-600 mt-2 not-italic">— Intendente Emiliano Torres</footer>
            </blockquote>

            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              Durante 2025, la Provincia de Córdoba prevé una inversión total de <strong>$16.384 millones</strong> en el
              sistema de bomberos voluntarios. Esta inversión incluye no solo transferencias directas a los cuarteles,
              sino también la incorporación de un nuevo avión hidrante Air Tractor 802 F, equipamiento técnico,
              motobombas, camionetas, tecnología, y un programa de becas de capacitación y cobertura de salud para más
              de <strong>4.400 bomberos</strong> en todo el territorio provincial.
            </p>

            {/* Equipment Image */}
            <div className="mb-12">
              <Image
                src="/images/bomberos-recaudacion-2.jpg"
                alt="Equipamiento para bomberos voluntarios"
                width={800}
                height={600}
                className="w-full h-auto rounded-lg shadow-lg"
              />
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-12">
              <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                Desde la <strong>Municipalidad de Villa del Dique</strong> celebramos este respaldo institucional que
                fortalece a una de las instituciones más valoradas por la comunidad, y reafirmamos nuestro compromiso de
                seguir acompañando su labor con <strong>gestión y presencia</strong>.
              </p>
            </div>
          </div>

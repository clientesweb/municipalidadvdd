...
export default function AvanzandoJuntosPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "La gestión municipal encabezada por el intendente Emiliano Torres informa a la comunidad los avances logrados en el marco del plan de obras públicas que se lleva adelante en nuestra localidad.",
  ...
  const shareOnSocial = (platform: "facebook" | "twitter" | "whatsapp") => {
    ...
    const title = encodeURIComponent("Avanzando juntos hacia un futuro mejor en Villa del Dique")
    const text = encodeURIComponent(
      "La gestión municipal encabezada por el intendente Emiliano Torres informa a la comunidad los avances logrados en el marco del plan de obras públicas.",
    )
      ...
      <main className="flex-grow container mx-auto py-8 px-4 sm:py-12 md:py-16 lg:py-20">
        ...
        <div className="mb-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Avanzando juntos hacia un futuro mejor</span>
          </nav>
        </div>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">16 de marzo de 2024</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-[#16b5d0]/10 border-l-4 border-[#16b5d0] p-4 mb-8">
              <p className="text-lg font-semibold text-[#16b5d0]">
                🏗️ OBRAS PÚBLICAS: Avances significativos en infraestructura y servicios municipales
              </p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8">
              La gestión municipal encabezada por el intendente <strong>Emiliano Torres</strong> informa a la comunidad
              los avances logrados en el marco del plan de obras públicas que se lleva adelante en nuestra localidad.
            </p>

            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              Desde el inicio de la gestión se ha trabajado intensamente en la{" "}
              <strong>reorganización y reestructuración del área de Obras Públicas</strong>, con el propósito de
              asegurar un servicio más eficiente y de calidad para todos los vecinos.
            </p>

            {/* Video Section */}
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Video: Avances en Obras Públicas</span>
              </h3>
                ...
                <div className="relative w-full max-w-md mx-auto bg-black rounded-lg overflow-hidden shadow-lg">
                  <div style={{ aspectRatio: "9/16" }}>
                    <video
                      ...
                      poster="/avanzando-juntos.webp"
                      preload="metadata"
                    >
                      <source src="/videos/avanzando-juntos.mp4" type="video/mp4" />
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-sm text-gray-600 text-center">
                      <strong>Video oficial:</strong> Resumen de los avances en obras públicas y servicios municipales
                      en Villa del Dique.
                    </p>
                  </div>
                </div>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Infraestructura Educativa</span>
              </h2>

              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                En materia de infraestructura educativa, se priorizó la{" "}
                <strong>seguridad de los niños y niñas de Villa del Dique</strong>. En la{" "}
                <strong>Escuela Almirante Guillermo Brown</strong> se están ejecutando trabajos de instalación de
                sistemas de gas y electricidad en todo el establecimiento.
              </p>

              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#16b5d0] mb-8">
                <h4 className="text-xl font-bold text-gray-900 mb-4">Proyectos en Curso</h4>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start space-x-2">
                    <span className="text-[#16b5d0] font-bold">•</span>
                    <span>Instalación de sistemas de gas y electricidad en Escuela Almirante Guillermo Brown</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#16b5d0] font-bold">•</span>
                    <span>
                      Construcción del nuevo edificio para la <strong>"Sala Cuna"</strong> - espacio seguro para la
                      primera infancia
                    </span>
                  </li>
                </ul>
            ...
            <section className="mb-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Espacios Verdes y Obras Públicas</span>
              </h3>

              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                En paralelo, la cuadrilla de <strong>Espacios Verdes</strong> continúa con la recuperación y
                embellecimiento de los espacios públicos. Entre las tareas destacadas se encuentran el{" "}
                <strong>adoquinado de la rotonda del Estudiante</strong> y la proyección de nuevas calles, con el fin de
                optimizar el escurrimiento del agua en días de lluvia.
              </p>

              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#16b5d0]">
                  <h4 className="text-xl font-bold text-gray-900 mb-4">Espacios Verdes</h4>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start space-x-2">
                      <span className="text-[#16b5d0] font-bold">•</span>
                      <span>Recuperación y embellecimiento de espacios públicos</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#16b5d0] font-bold">•</span>
                      <span>Adoquinado de la rotonda del Estudiante</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#0ea5e9]">
                  <h4 className="text-xl font-bold text-gray-900 mb-4">Infraestructura Vial</h4>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start space-x-2">
                      <span className="text-[#0ea5e9] font-bold">•</span>
                      <span>Proyección de nuevas calles</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-[#0ea5e9] font-bold">•</span>
                      <span>Optimización del escurrimiento del agua</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section className="mb-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Seguridad Ciudadana</span>
              </h3>

              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                En coordinación con el área de <strong>Seguridad Ciudadana y Control de Tránsito</strong>, se están
                implementando mejoras en iluminación y señalización vial en diferentes sectores del municipio,
                garantizando así mayor seguridad para peatones y conductores.
              </p>
            </section>

            <section className="mb-12">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Acción Social</span>
              </h3>

              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                También se resalta el trabajo articulado con el área de <strong>Acción Social</strong>, mediante el cual
                se brinda apoyo a familias de escasos recursos a través de ayuda en mano de obra. Además, se realizan
                tareas de mantenimiento en instituciones locales, como el{" "}
                <strong>Hospital Rivarola y el Colegio Primario</strong>.
              </p>

              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#16b5d0] mb-8">
                <h4 className="text-xl font-bold text-gray-900 mb-4">Apoyo Social</h4>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start space-x-2">
                    <span className="text-[#16b5d0] font-bold">•</span>
                    <span>Apoyo a familias de escasos recursos con mano de obra</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#16b5d0] font-bold">•</span>
                    <span>Mantenimiento en Hospital Rivarola</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#16b5d0] font-bold">•</span>
                    <span>Trabajos de mantenimiento en Colegio Primario</span>
                  </li>
                </ul>
              </div>
            </section>
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-12">
              <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                La Municipalidad de Villa del Dique reafirma así su{" "}
                <strong>compromiso con el desarrollo, la seguridad y el bienestar de toda la comunidad</strong>,
                avanzando con determinación hacia un <strong>futuro más próspero y solidario</strong>.
              </p>
            </div>
          </div>

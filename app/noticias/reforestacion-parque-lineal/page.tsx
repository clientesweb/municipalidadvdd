...
export default function ReforestacionParqueLinealPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Reforestación y educación ambiental en el Parque Lineal: un compromiso que crece con la comunidad",
      text: "La Municipalidad de Villa del Dique continúa avanzando en la consolidación del pulmón verde de nuestro Parque Lineal.",
  ...
  const shareOnSocial = (platform: "facebook" | "twitter" | "whatsapp") => {
    ...
    const title = encodeURIComponent(
      "Reforestación y educación ambiental en el Parque Lineal: un compromiso que crece con la comunidad",
    )
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">6 de mayo de 2025</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-[#16b5d0]/10 border-l-4 border-[#16b5d0] p-4 mb-8">
              <p className="text-lg font-semibold text-[#16b5d0]">
                🌱 IMPORTANTE: Villa del Dique continúa fortaleciendo su compromiso con el medio ambiente y la educación
                ambiental
              </p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8">
              La <strong>Municipalidad de Villa del Dique</strong> continúa avanzando en la consolidación del pulmón
              verde de nuestro Parque Lineal. En esta oportunidad, se plantaron <strong>30 algarrobos</strong> en una
              jornada de reforestación y concientización ambiental realizada junto a la comunidad educativa de la{" "}
              <strong>Escuela Almirante Guillermo Brown</strong>.
            </p>

            {/* Hero Image */}
            <div className="mb-12">
              <Image
                src="/parque-lineal-1.jpg"
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Educación Ambiental en Acción</span>
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">
                    ...
                    <strong>espacios de aprendizaje y reflexión sobre el cuidado del entorno</strong>, y se enmarcó en
                    una política sostenida de promoción de la educación ambiental en nuestras instituciones escolares.
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Los estudiantes participaron activamente en la plantación, aprendiendo sobre la importancia de los
                    árboles nativos y su rol en el ecosistema local.
                  </p>
                </div>
                <div>
                  <Image
                    src="/parque-lineal-2.jpg"
                    alt="Educación ambiental con estudiantes de la Escuela Almirante Brown"
                    width={600}
                    height={400}
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Infraestructura Sostenible</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <Image
                    src="/parque-lineal-3.jpg"
                    alt="Cestos para separación de residuos y bicicleteros en el Parque Lineal"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
                ...
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Como parte de esta iniciativa, se entregaron{" "}
                    <strong>kits de cestos para residuos —elaborados con materiales biodegradables—</strong> destinados
                    a la separación de desechos, y <strong>dos bicicleteros</strong>, fomentando así prácticas
                    sostenibles y hábitos responsables en el uso del espacio público.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Un Compromiso que Crece</span>
              </h2>

              <div className="grid md:grid-cols-2 gap-8 items-center mb-6">
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Desde el Municipio, reafirmamos nuestro compromiso de{" "}
                    <strong>seguir trabajando articuladamente con las escuelas del pueblo</strong>, convencidos de que
                    el cuidado del ambiente comienza con la educación, la participación y la acción concreta.
                  </p>
                </div>
                <div>
                  <Image
                    src="/parque-lineal-4.jpg"
                    alt="Collage de momentos de la jornada de reforestación"
                    width={600}
                    height={400}
                    className="w-full h-auto rounded-lg shadow-md"
                  />
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">
                <span className="text-[#16b5d0]">Momentos de la Jornada</span>
              </h2>

              <div className="mb-8">
                <Image
                  src="/parque-lineal-5.jpg"
                  alt="Niños celebrando la plantación de árboles"
                  width={800}
                  height={600}
                  className="w-full h-auto rounded-lg shadow-lg"
                />
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-12">
              <p className="text-xl text-gray-800 leading-relaxed text-center font-medium">
                ...
                <strong>
                  Villa del Dique se consolida como un pueblo comprometido con el medio ambiente y las futuras
                  generaciones
                </strong>
                . La educación ambiental y la participación comunitaria son los pilares fundamentales para{" "}
                <strong>construir un futuro más verde y sostenible</strong>.
              </p>
            </div>
          </div>
